...
const TGPSCMainsPYQPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchQuizzes = async () => {
      try {
        // Query quizzes with quizType = 'mainsPyqs' and examBoard = 'tgpsc'
        const q = query(
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            TGPSC Mains Previous Year Questions
          </h1>
          <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
            Practice with actual questions from previous TGPSC Mains examinations
          </p>
        </div>
...
export default TGPSCMainsPYQPage;
